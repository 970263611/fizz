...
public class SqlParse {
    ...
    public static MapperSqlInfo parseMapperFile(String filePath,InputStream in, DbType dbType) throws Exception {
        Configuration configuration = createConfiguration();
        XMLMapperBuilder mapperParser = createMapperParser(filePath, in,configuration);
        mapperParser.parse();
    ...
    private static XMLMapperBuilder createMapperParser(String filePath,InputStream in, Configuration configuration)
        throws IOException {
